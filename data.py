...
def get_c4(nsamples, seed, seqlen, tokenizer):
    ...
    dataset1 = Dataset.from_file("/root/.cache/huggingface/datasets/allenai___c4/default-b04fc8a0b8562884/0.0.0/1588ec454efa1a09f29cd18ddd04fe05fc8653a2/c4-train-00000-of-00002.arrow")
    dataset2 = Dataset.from_file("/root/.cache/huggingface/datasets/allenai___c4/default-b04fc8a0b8562884/0.0.0/1588ec454efa1a09f29cd18ddd04fe05fc8653a2/c4-train-00001-of-00002.arrow")

    traindata = concatenate_datasets([dataset1, dataset2]) 
    valdata = Dataset.from_file("/root/.cache/huggingface/datasets/allenai___c4/default-c7bc8b0aefc5e48f/0.0.0/1588ec454efa1a09f29cd18ddd04fe05fc8653a2/c4-validation.arrow")
...
def get_alpaca(nsamples, seed, seqlen, tokenizer):
    """
    Load and process the Alpaca dataset for language modeling.
    ...
    # Convert instruction-style samples into plain text prompts
    texts = []
    ...
    # Tokenize the entire dataset as a long string for training-like slicing
    ...
    # Encode test data (use first 100 samples for evaluation)
    test_texts = texts[:100]
    test_enc = tokenizer("\n\n".join(test_texts), return_tensors='pt')

    return trainloader, test_enc
